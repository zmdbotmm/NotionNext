...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Spare', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '慰祝苍生乐大同', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sparedog.click', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '历史地理, 博客', // 网站关键词 英文逗号隔开
